# Modified ZKB++
This is a modified version of ZKB++, modified by Cybernetica AS to interface with the ZK-SecreC compiler.
The original unmodified code is in https://github.com/IAIK/gzkbpp.

The license in LICENSE pertains to the original code of ZKB++.
The license in LICENSE-CYBERNETICA pertains to all modifications and additions made to ZKB++.

The text from the original README.md file follows.
